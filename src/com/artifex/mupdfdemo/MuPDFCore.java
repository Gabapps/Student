...
public class MuPDFCore
{
	...
	private native void addInkAnnotationInternal(PointF[][] arcs, float[] color, float thickness); //modified
	...
	private native int getCurrentPageInternal();
	...
	public synchronized void addInkAnnotation(int page, PointF[][] arcs, float[] color, float thickness) { // modified
		gotoPage(page);
		addInkAnnotationInternal(arcs, color, thickness);
	}
