...
public abstract class PageView extends ViewGroup {
	...
	protected static int ink_color = 0xFF0000FF;
	protected static float ink_thickness = 1.0f;
	...
	public static float[] convertColor(int color) {
		...
		res[0]=(float)(color&0xff)/255;
		res[1]=(float)((color>>4)&0xff)/255;
		res[2]=(float)((color>>8)&0xff)/255;
		return res;
	}
	...
	public void setInkThickness(int thickness) {
		ink_color=thickness;
	}
